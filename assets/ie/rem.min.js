(function (window, undefined) {
  ...
  // Test for Media Query support
    ...
    removeMediaQueries = function(css) {
        if (!mediaQuery()) {
            css.replace(/@media[\s\S]*\}\s*\}/, ""); // Match and replace every occurance of a media query with nothing
            // Note: Since @rules can't be nested in the CSS spec, we're safe to just check for the next double closing bracket.
        }
        return css;
    },
